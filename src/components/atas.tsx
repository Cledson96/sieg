...
export default function Atas() {
  ...
  return (
    <section className="bg-white w-full" id="Atas">
      <div className="container mx-auto px-10 py-10 bg-white">
        ...
        <ul className="flex place-content-between w-full py-5 font-normal text-gray-600 text-base cursor-pointer px-3 flex-wrap	">
          <li
            className={`hover:bg-padraoHover ${
              filtro === "Computadores" &&
              "border-b-2 border-orange-600 flex-wrap"
            }`}
